...
#tb = TensorBoard('logs')
#callbacks=[tb], 
regressor.fit(x_train,y_train,epochs=100,batch_size =64,validation_split=0.2)
...
predicted_stock_price = predicted_stock_price[:,0:1]
#real_stock_price1 = sc.transform(real_stock_price)
